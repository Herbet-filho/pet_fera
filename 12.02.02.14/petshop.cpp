...
PetShop::determinarClasse(Animal* animal_inserido, string nutricao, string risco_extincao, bool periculosidade, 
    ...
    switch (escolha){
        case 1:
        {
            ...
            //this->pegarVeterinario(animal_inserido);
            
            Anfibio* anfibio= new Anfibio(nutricao, risco_extincao, periculosidade, 
                        id, especie, sexo, fecundacao, str1, str2,  str3, str4);
            i = pegarTratador(*anfibio,1);
            anfibio->setTratador(*trat[i]);
        ...
        {    
            ...
            animal_inserido->setTratador(*trat[i]);
            Reptil* reptil = new Reptil(nutricao, risco_extincao, periculosidade, 
                        id, especie, sexo, fecundacao, str1, str2);
            
            reptil->setTratador(*trat[i]);
        ...
        case 3:
        {
            ...
            animal_inserido->setTratador(*trat[i]);
            Ave* ave = new Ave(nutricao, risco_extincao, periculosidade, 
                        id, especie, sexo, fecundacao, boolean1, str1, str2);
            ave->setTratador(*trat[i]);
            this->addAve(ave);
            break;
        }
        case 4:
        {
            ...
            animal_inserido->setTratador(*trat[i]);
            Mamifero* mamifero = new Mamifero(nutricao, risco_extincao, periculosidade, 
                        id, especie, sexo, fecundacao, str1, str2);
            mamifero->setTratador(*trat[i]);
    ...
    if (this->getCapacidade_veterinario() > 0 && this->getCapacidade_tratador() > 0){
        ...
        switch(escolha2){
            ...
            case 1: // ******  Anfibio ****** //
            {
                ...
                Anfibio* anfibio= new Anfibio(nutri, risco_ext, periculosi, ID, Especie, Sexo,
                Fecundacao, str1, str2,  str3, str4);
                anfibio->setVeterinario(*vets[escolha]);
                anfibio->setTratador(*trat[i]);
            ...
            case 2: // *******  Ave  ************ //
            {
                ...
                bicho->setTratador(*trat[i]);
                Ave* ave= new Ave(nutri, risco_ext, periculosi, ID, Especie, Sexo,
                Fecundacao, boolean1, str1, str2);
                ave->setVeterinario(*vets[escolha]);
                ave->setTratador(*trat[i]);
                this->addAve(ave);
                break;
            }
            case 3: // ***********  Mamifero  **************** //
            {
                ...
                bicho->setTratador(*trat[i]);
                Mamifero* mamifero= new Mamifero(nutri, risco_ext, periculosi, ID, Especie, Sexo,
                Fecundacao, str1, str2);
                mamifero->setVeterinario(*vets[escolha]);
                mamifero->setTratador(*trat[i]);
                this->addMamifero(mamifero);
                break;
            }
            case 4: // **********  Reptil  *********** //
            {
                ...
                bicho->setTratador(*trat[i]);
                Reptil* reptil= new Reptil(nutri, risco_ext, periculosi, ID, Especie, Sexo,
                Fecundacao, str1, str2);
                reptil->setVeterinario(*vets[escolha]);
                reptil->setTratador(*trat[i]);
                this->addReptil(reptil);
                break;
            }
