...
PetShop::listarMamiferos(){
    if (this->capacidade_mamifero == 0){
        ...
        cout << mamifero[0]->getId() << "nao foi dessa vez" << endl;
        cout << mamifero[0]->getEspecie() << endl;
        for(int i = 0; i < 2; i++){
...
PetShop::addMamifero(Mamifero* mamifero_inserido){
    if (capacidade_mamifero < CAPACIDADE_MAX_MAMIFERO){
        mamifero[this->capacidade_mamifero++] = mamifero_inserido;
    }
}
...
PetShop::CadastrarAnimal(){
    ...
    switch (escolha){
        case 1://******  Anfibio ******
        {
            ...
            Anfibio* anfibio= new Anfibio(*bicho, str1, str2,  str3, str4);
            this->addAnfibio(anfibio);
            break;
        }
        case 2://**********  Reptil  ***********
        {    
            ...
            bicho->setTratador(*trat[i]);
            Reptil* reptil = new Reptil(*bicho,str1,str2);
            this->addReptil(reptil);
            break;
        }
        case 3://*******  Ave  ************
        {
            ...
            bicho->setTratador(*trat[i]);
            Ave* ave = new Ave(*bicho, boolean1, str1, str2);
            cout << ave->getVoa() << "aqui a especie dessa caceta" << endl;
            this->addAve(ave);
            break;
        }
        case 4://***********  Mamifero  ****************
        {
            ...
            bicho->setTratador(*trat[i]);
            Mamifero* mamifero = new Mamifero(*bicho, str1, str2);
            this->addMamifero(mamifero);
            break;
        }    
    }//*****************************************************
