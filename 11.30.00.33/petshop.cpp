...
PetShop::Funcionamento(){
    ...
    if (primeiraescolha == 1){
        ...
        cout << endl;
        cout << "2 - Remover veterinario do petshop" << endl;
        cout << endl;
        cout << "3 - Alterar dados de um determinado veterinário" << endl;
        cout << endl;
        ...
        cout << endl;
        cout << "2 - Remover tratador do petshop" << endl;
        cout << endl;
...
PetShop::CadastrarAnimal(){
    if (this->getCapacidade_veterinario() > 0 && this->getCapacidade_tratador() > 0){
        ...
        this->determinarclasse(animais); 
    }else{          //olha la em cima feioso
