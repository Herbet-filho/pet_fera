...
class PetShop: public Silvestre, public Anfibio, public Reptil, public Ave, public Mamifero/*, public Animal */{
    string nome;
...
public:
    ...
    void pegarTratador(Animal* animal_inserido, int nivel);
