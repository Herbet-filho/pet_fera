...
#define CAPACIDADE_MAX_SILVESTRE 100
#define CAPACIDADE_MAX_DOMESTICO 100
...
class PetShop: public Anfibio, public Reptil, public Ave, public Mamifero {
    string nome;
    ...
    Silvestre* silvestre[CAPACIDADE_MAX_SILVESTRE];
    int capacidade_silvestre = 0;
    Domestico* domestico[CAPACIDADE_MAX_DOMESTICO];
    int capacidade_domestico = 0;
...
public:
    ...
    /*int getCapacidade_silvestre();
    int getCapacidade_domestico();*/
    ...
    //void listarSilvestres();
    //void listarDomesticos();
    ...
    /*void AveSilvestre();
    void AveDomestica();
    void AnfibioSilvestre();
    void AnfibioDomestico();
    void MamiferoSilvestre();
    void MamiferoDomestico();
    void reptilSilvestre();
    void reptilDomestico();*/
